 ...
 * Description: Contains the Binop class that 
 * defines a left child and right child; And has 
 * addRandomKids method that potentially can add 
 * new nodes that are operators, consts, or variables
 * 
 */
...
public abstract class Binop extends Node {
	...
	*/
    ...
    returned, depending on whether the current node is the parent,
