...
public class SimpleInput {
    ...
    public SimpleInput(String file) throws RuntimeException {
        ...
        if (!details.exists())
            throw new RuntimeException(file + " does not exist."); //taking care of various exceptions
    ...
    public void setDelimiters(String d) { //setting delimiters 
    ...
    private static final BufferedReader stdinReader = new BufferedReader(new InputStreamReader(System.in)); //wrappping buffered reader
